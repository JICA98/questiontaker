...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends App_HiltComponents.ActivityC {
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      MainActivity_MembersInjector.injectRepository(instance, singletonCImpl.questionRepositoryProvider.get());
      return instance;
    }
  }
  ...
  private static final class SingletonCImpl extends App_HiltComponents.SingletonC {
    ...
    dagger.internal.Provider<QuestionRepository> questionRepositoryProvider;
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.questionRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<QuestionRepository>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements dagger.internal.Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.questiontaker.data.QuestionRepository
          return (T) new QuestionRepository(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
